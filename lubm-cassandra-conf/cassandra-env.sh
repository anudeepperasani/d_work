...
if [ "`uname`" = "Linux" ] ; then
    ...
    # java 1.7.25 needs 190k
    # java 1.7.45 needs 250k
...
# enable the old dse state model by default. After the upgrade is done
# or after a fresh install, please comment this line out
JVM_OPTS="$JVM_OPTS -Denable-old-dse-state=true"

# Pick up any extra args.
JVM_OPTS="$JVM_OPTS $JVM_EXTRA_OPTS"

# Address CASSANDRA-6541
